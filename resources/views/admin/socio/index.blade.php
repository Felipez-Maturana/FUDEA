...
@section('contenido')
	...
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-10">
			...
			@include('admin.socio.search')
		</div>
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-2">
		{{Form::open(['action' => 'SocioController@actualizarEstado']) }}
			<a href="{{action('SocioController@actualizarEstado')}}"> <button class="btn btn-success">Actualizar Suscripción</button></a>
		{{Form::close() }}
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-condensed table-hover">
					...
					<tr>
						...
						<td><a href="{{URL::action('SocioController@edit',$soc->idSocio)}}"><button class="btn btn-info">Editar</button></a></td>
						<td><a href="" data-target="#modal-delete-{{$soc->idSocio}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a></td>
					</tr>
					@include('admin.socio.modal')
					@endforeach
				</table>
			</div>
			{{$socios->render()}}
